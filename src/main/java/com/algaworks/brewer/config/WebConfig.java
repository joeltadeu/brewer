...
import com.algaworks.brewer.config.format.IntegerFormatter;
...
@Configuration
@ComponentScan({"com.algaworks.brewer.controller", "com.algaworks.brewer.session"})
@EnableWebMvc
...
public class WebConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
	...
	public ViewResolver viewResolver() {
		...
		resolver.setCharacterEncoding("UTF-8"); // http://www.utf8-chartable.de
		return resolver;
	}
	...
	public FormattingConversionService mvcConversionService() {
		...
		IntegerFormatter integerFormatter = new IntegerFormatter("#,##0");
