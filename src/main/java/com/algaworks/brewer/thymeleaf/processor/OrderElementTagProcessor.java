...
public class OrderElementTagProcessor extends AbstractElementTagProcessor {
	...
	public OrderElementTagProcessor(TemplateMode templateMode, String dialectPrefix, String elementName,
	...
	protected void doProcess(ITemplateContext context, IProcessableElementTag tag,
		...
		model.add(modelFactory.createStandaloneElementTag("th:block", "th:replace", String.format("layout/fragments/ordination :: order (%s, %s, '%s')", page.getValue(), field.getValue(), text.getValue())));
