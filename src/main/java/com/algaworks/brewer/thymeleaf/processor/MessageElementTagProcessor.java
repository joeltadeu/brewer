...
public class MessageElementTagProcessor extends AbstractElementTagProcessor {
	...
	protected void doProcess(ITemplateContext context, IProcessableElementTag tag,
		...
		model.add(modelFactory.createStandaloneElementTag("th:block", "th:replace", "layout/fragments/success-message :: alert"));
		model.add(modelFactory.createStandaloneElementTag("th:block", "th:replace", "layout/fragments/error-message :: alert"));
