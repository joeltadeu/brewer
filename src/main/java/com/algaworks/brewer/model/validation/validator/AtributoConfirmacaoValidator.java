package com.algaworks.brewer.model.validation.validator;
...
public class AtributoConfirmacaoValidator implements ConstraintValidator<AtributoConfirmacao, Object> {
	...
	public boolean isValid(Object object, ConstraintValidatorContext context) {
		...
		try {
			...
			valido = ambosNull(valorAtributo, valorAtributoConfirmacao)
					|| ambosIguais(valorAtributo, valorAtributoConfirmacao);
		} catch (Exception e) {
			throw new RuntimeException("{generic.exception.erro.recuperando.valores.atributos}");
		}
	...
	private boolean ambosNull(Object valorAtributo, Object valorAtributoConfirmacao) {
